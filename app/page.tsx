  ...
  return (
    ...
    >
      ...
      >
        ...
        <p>
          BAMToolz connects existing barcodes, QR codes,
      ...
      >
        ...
        <p>
          Machines should not lose their history.
          Facilities should not lose their knowledge.
      ...
      >
        ...
        <p>
          🔒 Customer equipment data belongs to the customer.
        </p>
      ...
      >
        ...
        <p>
          BAM Scan™ • BAM Hub™ • Preserving Presence™
        </p>
