      ...
      <div className="mx-auto max-w-7xl rounded-[2rem] border border-cyan-300/40 bg-gradient-to-br from-cyan-500 via-cyan-600 to-blue-900 p-5 shadow-2xl sm:p-8">
        <header className="flex flex-col gap-6 sm:flex-row sm:items-start sm:justify-between">
          ...
          <nav className="flex flex-wrap gap-3">
            ...
            <a href="/scanner" className="rounded-lg bg-slate-950 px-4 py-2 text-xs font-bold text-cyan-200 shadow-lg">BAM Scan™</a>
        ...
        <section className="mt-10 rounded-2xl bg-slate-950/95 p-8 shadow-2xl sm:p-10">
          ...
          <h2 className="mt-4 max-w-5xl text-4xl font-black leading-tight tracking-tight sm:text-6xl">
            One access layer for homes, technicians, facilities, and admins.
          </h2>

          <p className="mt-6 max-w-6xl text-sm leading-6 text-slate-300 sm:text-base">
            BAM Access™ will control user accounts, protected repair records,
            machine intelligence, service workflows, facility data, and customer
            dashboards across the BAM ecosystem.
          </p>
        </section>
        ...
        <section className="mt-8 grid gap-5 md:grid-cols-2 xl:grid-cols-4">
          <AccessCard
            title="BAM Home™ User"
            text="Everyday users can scan appliances, vehicles, tools, home systems, and repair issues with BAM AI™ support."
          />

          <AccessCard
            title="BAM Technician™"
            text="Technicians can receive repair requests, review scan details, add notes, and support service workflows."
          />

          <AccessCard
            title="BAM Facility™"
            text="Companies can protect machine data, maintenance history, work orders, documents, and facility intelligence."
          />

          <AccessCard
            title="BAM Admin™"
            text="Admins can manage users, permissions, roles, companies, assets, and protected BAM ecosystem data."
          />
        </section>
        ...
        <section className="mt-8 rounded-2xl border border-cyan-300/40 bg-slate-950/95 p-8 shadow-2xl">
          ...
          <p className="mt-4 max-w-5xl text-sm leading-6 text-slate-300">
            Future authentication will connect BAM Home™ accounts, technician
            profiles, facility dashboards, admin controls, protected machine
            records, repair requests, and BAM Provider Network™ access.
          </p>
